...
module.exports.addFeedAPIRouter = function(app) {
    var router = express.Router();

    router.route('/feeds').get(getFeeds);
    router.route('/feeds/subscribe').put(feedSubscribe);
    router.route('/feeds/:feedID/search').get(getFeedEntrySearch);
    router.route('/feeds/:feedID').delete(feedUnsubscribe);
    router.route('/feeds/:feedID/entries').get(getFeedEntries);
    router.route('/feeds/:feedID').put(updateFeedReadStatus);
    router.route('/feeds/:feedID/entries/:entryID').put(updateFeedEntryReadStatus);
...
var feedSubscribe = function(req, res) {
...
var getFeedEntrySearch = function(req, res) {
...
var feedUnsubscribe = function(req, res) {
    var feedID = req.params.feedID;
...
var getFeedEntries = function(req, res) {
    var feedID = req.params.feedID;
    var user = null;
    var errStr = null;
    var resultStatus = null;
...
var updateFeedReadStatus = function(req, res) {
    var feedID = req.params.feedID;
    var user = null;
    var errStr = null;
    var resultStatus = null;
...
var updateFeedEntryReadStatus = function(req, res) {
    var feedID = req.params.feedID;
